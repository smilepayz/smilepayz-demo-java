...
public class PayInRequestDemo {
    ...
    public static void main(String[] args) {
        ...
        String sandboxPath = "https://sandbox-gateway-test.smilepayz.com" + endPointUlr;
        String prodPath = "https://gateway.smilepayz-test.com" + endPointUlr;
        ...
        merchantReq.setMerchantId(sandboxMerchantId);
