...
import com.smilepayz.philippines.bean.MerchantReq;
import com.smilepayz.philippines.bean.MoneyReq;
import com.smilepayz.philippines.bean.PayerReq;
import com.smilepayz.philippines.bean.TradePayinReq;
...
public class PayInRequestDemo {
    ...
    public static void main(String[] args) {
        ...
        doTransaction(env, merchantId, merchantSecret, privateKeyString, paymentMethod, amount, payerName, email, phone);
    }
    ...
    public static void doTransaction(String env,
        ...
        payerReq.setName(payerName);
        payerReq.setEmail(email);
        payerReq.setPhone(phone);
